...
public class NewBehaviourScript : MonoBehaviour
{
    ...
    private List<Camera> camInSceneList = new List<Camera>();
...
/// </summary>
    ...
    void Awake(){
        ...
        camInSceneList.Add(Camera2);
        camInSceneList.Add(Camera3);
        camInSceneList.Add(Camera4);
        camInSceneList.Add(mainCamera);
        Debug.Log(camInSceneList);
    }
