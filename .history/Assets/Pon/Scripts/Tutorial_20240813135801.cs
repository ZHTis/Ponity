...
public class Tutorial : MonoBehaviour
{
    ...
    private Text text; private Text text4;
    ...
    void Awake(){
        ...
        text4 = Camera4.GetComponentInChildren<Text>();
        Debug.Log(text.text); Debug.Log( text4.text);
    }
    // Start is called before the first frame update
    void Start()
    {
        StartCoroutine(EnterBreak(
         "Let's take a few minates to get used to the task."));
        StartCoroutine(StartTutorial());
    }

    IEnumerator EnterBreak(string message){
        text.text = message;
