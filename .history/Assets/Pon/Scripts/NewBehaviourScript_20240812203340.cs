    ...
    IEnumerator ThisIsIt(int how=0)
    {
        ...
        switch(how)//history lept
        {
            ...
            //fully randomized design
                ...
                if_Shuffle(combinations.ToArray(),true);
                Debug.Log(combinations.ToArray().Length);
                var combinationList = new {};
                foreach (var combination in combinations){
                    Debug.Log(combination);
                    var it = new [] {combination.ratio,combination.e.tar, combination.e.f.id, combination.e.f.neck};
                    }
