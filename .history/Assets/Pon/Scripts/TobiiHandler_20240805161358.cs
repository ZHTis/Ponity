...
public class TobiiHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        SizeLeft.GetComponent<RectTransform>().localScale = new Vector3(LeftPupilData.PupilDiameter, LeftPupilData.PupilDiameter, LeftPupilData.PupilDiameter);
        //transform.localScale = new Vector3(LeftPupilData.PupilDiameter, LeftPupilData.PupilDiameter, LeftPupilData.PupilDiameter);
        ...
        //cursor.transform.position = maincamera.ScreenToWorldPoint(new Vector3(LeftGaze.PositionOnDisplayArea.x, LeftGaze.PositionOnDisplayArea.y, VisualizationDistance));
    }
