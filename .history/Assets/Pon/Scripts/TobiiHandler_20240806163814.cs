...
public class TobiiHandler : MonoBehaviour
{
    ...
    void SaveData(){
        ...
        var jsonData  = JsonConvert.SerializeObject(eyeDataToSave);
       ...
       File.WriteAllText
        (Application.dataPath + "/Resources/EyeData/" + System.DateTime.Now.ToString("-MM-dd-HH-mm-ss-yyyy") + ".json", 
        jsonData);
    }
    ...
    void OnDestroy(){
        ...
        dataOutput.SaveData(eyeDataToSave, "/Resources/EyeData/", behaviorC.PlayerName);
    }
}
