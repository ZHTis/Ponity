...
public class coinHub : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 aimPos = aim.transform.position+ transform.position;
        point1 = new Vector2(Cannon.transform.position.x, Cannon.transform.position.y);
        point2 = new Vector2(aimPos.x, aimPos.y);
    }
    ...
    private void Spawn()
    {
        ...
        Vector3 vector = new Vector3(iniVel_forward.x, iniVel_forward.y, 0);
