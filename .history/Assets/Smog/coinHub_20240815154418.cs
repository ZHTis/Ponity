...
public class coinHub : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        point1 = new Vector2(Cannon.transform.position.x, Cannon.transform.position.z);
        point2 = new Vector2(aim.transform.position.x, aim.transform.position.z);
        Debug.DrawLine(point1, point2, Color.red, 10f);
        Vector2 iniVel_forward = (point2 - point1).normalized * vel_forward;
        vector = new Vector3(iniVel_forward.x,0,iniVel_forward.y);
    }
