...
public class pathSimulator : MonoBehaviour
{
    ...
    private float simulateOffset=0.8f;
    ...
    void Update()
    {
        SimulateTrajectory(_pon, new Vector3 (0,0,0),new Vector3 (_ponCharacter.vel_x,_ponCharacter.vel_y,0),_ponCharacter.withMarker);
        giveHitPoints();
    }
